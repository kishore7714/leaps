...
import com.leaps.serviceImpl.admin.CompanyServiceImpl;
...
public class CompanyController {
    ...
    public ResponseEntity<CompanyResponse> getallWithPagination(
            @RequestParam(value = "pageNo", defaultValue = DEFAULT_PAGE_NUMBER, required = false) int pageNo,
            @RequestParam(value = "pageSize", defaultValue = DEFAULT_PAGE_SIZE, required = false) int pageSize,
            @RequestParam(value = "sortBy", defaultValue = DEFAULT_SORT_BY, required = false) String sortBy,
            @RequestParam(value = "sortDir", defaultValue = DEFAULT_SORT_DIRECTION, required = false) String sortDir) {
        HttpHeaders header = new HttpHeaders();
        CompanyResponse company = companyService.getAllWithPagination(pageNo, pageSize, sortBy, sortDir);
        header.add("description", "Company-getall-pagination");
        return new ResponseEntity<>(company, header, HttpStatus.OK);
        // return ResponseEntity.status(HttpStatus.OK).headers(header).body(company);
    }
    ...
    public ResponseEntity<CompanyDto> getbyid(@PathVariable Long id) {
        ...
        header.add("type", "Company Object");
    ...
    public ResponseEntity<String> add(@Valid @RequestBody CompanyDto CompanyDto) {
        HttpHeaders header = new HttpHeaders();
        header.add("description", "add-company");
        String add = companyService.add(CompanyDto);
        return new ResponseEntity<>(add, header, HttpStatus.CREATED);
    }

    // Update
    @PatchMapping("/update/{id}")
    public ResponseEntity<String> update(@Valid @PathVariable Long id, @RequestBody CompanyDto CompanyDto) {
        HttpHeaders header = new HttpHeaders();
        header.add("description", "update-company");
        String update = companyService.update(id, CompanyDto);
    ...
    public ResponseEntity<String> softDelete(@PathVariable Long id) {
        HttpHeaders header = new HttpHeaders();
        header.add("description", "soft-delete-company");
        String softdelete = companyService.softdelete(id);
    ...
    public ResponseEntity<String> hardDelete(@PathVariable Long id) {
        HttpHeaders header = new HttpHeaders();
        header.add("description", "hard-delete-company");
        String harddelete = companyService.harddelete(id);
        return new ResponseEntity<>(harddelete, header, HttpStatus.OK);
    }

    // Global Search
    @GetMapping("/global-search/{key}")
    public ResponseEntity<List<CompanyDto>> globalSearch(String key) {
        HttpHeaders header = new HttpHeaders();
        header.add("description", "global-search-company");
        List<CompanyDto> globalSearch = companyService.globalSearch(key);
